...
import { UserUpdateOneRequiredWithoutMessageNestedInputSchemaObject } from './UserUpdateOneRequiredWithoutMessageNestedInput.schema'

export const MessageUpdateInputSchemaObject = {
...
Joi.object().keys(BoolFieldUpdateOperationsInputSchemaObject)),
  ...
  user: Joi.object().keys(UserUpdateOneRequiredWithoutMessageNestedInputSchemaObject)
}